                            ...
                            <div class="col-md-4 border-end border-2">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 mb-3">
                                        ...
                                        <input type="number" name="competency_result[]" class="form-control" value="{{ $row->competency_result }}">
                                    </div>
                                </div>
                            </div>
                        @endforeach
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="performance_year" class="form-select">
                                        @for ($i = date('Y') - 5 ; $i <= date('Y') ; $i++)
                                            <option value="{{ $i }}" {{ $i == $performance->performance_year ? 'selected' : '' }}>{{ $i }}</option>
                                        @endfor
                                    </select>
                                </div>
                                <div class="col-md-5 mb-3">
                                    ...
                                    <input type="number" name="performance_result" class="form-control" value="{{ $performance->performance_result }}">
                                </div>
                            </div>
                        </div>
                    </div>
